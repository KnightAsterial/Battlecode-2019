...
(function (bc19) {
    var GeneralRobot = (function () {
        function GeneralRobot() {
        }
        /**
         * Called once to set up everything
         * @param {bc19.BCAbstractRobot} gameController
         */
        GeneralRobot.init = function (gameController) {
            GeneralRobot.gc = gameController;
        };
        return GeneralRobot;
    }());
    GeneralRobot.gc = null;
    bc19.GeneralRobot = GeneralRobot;
    GeneralRobot["__class"] = "bc19.GeneralRobot";
})(bc19 || (bc19 = {}));
(function (bc19) {
...
(function (bc19) {
    var Castle = (function (_super) {
        ...
        Castle.prototype.onAwake = function () {
            bc19.GeneralRobot.gc.log("I awake!");
        };
        Castle.prototype.doTurn = function () {
            bc19.GeneralRobot.gc.log("My testing is successful!");
            return bc19.GeneralRobot.gc.buildUnit(1, 1, 1);
        };
        return Castle;
    }(bc19.GeneralRobot));
    bc19.Castle = Castle;
...
(function (bc19) {
    var MyRobot = (function (_super) {
        ...
        MyRobot.prototype.turn = function () {
            try {
                if (MyRobot.numTurnSinceBirth === 0) {
                    this.unit = new bc19.Castle();
                    this.unit.onAwake();
                }
                return this.unit.doTurn();
            }
            catch (e) {
